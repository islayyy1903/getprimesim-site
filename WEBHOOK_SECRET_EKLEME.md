# Webhook Secret Vercel'e Ekleme

## ✅ WEBHOOK OLUŞTURULDU

`checkout.session.completed` event'i seçildi ve webhook oluşturuldu. Şimdi webhook secret'ı Vercel'e eklemeliyiz.
...
**Webhook secret'ı buldunuz mu? Vercel'e eklediniz mi? 🔍**
